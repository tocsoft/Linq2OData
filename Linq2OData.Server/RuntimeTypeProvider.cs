...
namespace Linq2OData.Server
{
    public class RuntimeTypeProvider : IRuntimeTypeProvider
    {
        ...
        private static readonly AssemblyName AssemblyName = new AssemblyName { Name = "Linq2OData.Server.Types" };
        ...
        {
            return fields.Aggregate("Linq2OData.Server<>" + sourceType.Name, (current, field) => current + (field.Key + field.Value.MemberType));
        }
    }
}
