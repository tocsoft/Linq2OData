...
namespace Linq2OData.Server
{
    internal static class GeneralExtensions
    {
        ...
        public static IEnumerable<TValue> GetValue<TKey, TValue>(this IEnumerable<KeyValuePair<TKey, TValue>> collection, TKey key)
        {
            return collection.Where(x => x.Key.Equals(key)).Select(x => x.Value);
        }
